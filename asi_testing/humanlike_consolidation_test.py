...
======================================================================
  Training Task A...
    Step 50/200, Loss: 0.0110
    Step 100/200, Loss: 0.0061
    Step 150/200, Loss: 0.0137
    Step 200/200, Loss: 0.0040

Evaluating Task A (immediately after training)...
  Task A Loss: 0.0089 (±0.0049)
...
======================================================================
  Consolidating Task A memories...
    Active clusters: [2]
    Consolidating cluster 2 (200 samples)...
    Consolidation complete!

Evaluating Task A (after consolidation)...
  Task A Loss: 0.0082 (±0.0043)
  Consolidation effect: -0.0007 (improved!)

======================================================================
PHASE 2: Learning Task B
======================================================================
  Training Task B...
    Step 50/200, Loss: 0.0082
    Step 100/200, Loss: 0.0131
    Step 150/200, Loss: 0.0154
    Step 200/200, Loss: 0.0060

Evaluating Task B (immediately after training)...
  Task B Loss: 0.0156 (±0.0083)

======================================================================
CHECKING TASK A (did learning Task B cause forgetting?)
======================================================================
  Task A Loss: 0.0172 (±0.0056)
...
======================================================================
  Consolidating Task B memories...
    Active clusters: [2]
    Consolidating cluster 2 (400 samples)...
    Consolidation complete!

Re-evaluating both tasks after Task B consolidation...
  Task A Loss: 0.0172 (±0.0046)
  Task B Loss: 0.0143 (±0.0069)
...
📊 Task A Journey:
  1. Immediate after training:  0.0089
  2. After consolidation:       0.0082 (-0.0007)
  3. After learning Task B:     0.0172 (+0.0090, +109.9%)
  4. After Task B consolidated: 0.0172
  5. After 50 relearning steps: 0.0088

🧠 Human-Like Properties:
  ✓ Consolidation preserves knowledge (minimal change)
  ✓✓ Minimal forgetting (109.9%) - excellent retention!
  ✓✓ Strong savings effect (49% improvement) - remembers gist!
  ✓ Both tasks remain functional - no total collapse
'''